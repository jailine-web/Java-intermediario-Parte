package com.projeto02.curso.config;
...
import com.projeto02.curso.entities.Payment;
import com.projeto02.curso.entities.Product;
import com.projeto02.curso.entities.User;
import com.projeto02.curso.enums.OrderStatus;
import com.projeto02.curso.repositories.CategoryRepository;
import com.projeto02.curso.repositories.OrderItemRepository;
import com.projeto02.curso.repositories.OrderRepository;
import com.projeto02.curso.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	@Autowired //injetar o repositório
	...
	public void run(String... args) throws Exception {
		...
		Payment pg1 = new Payment(null,Instant.parse("2019-06-20T19:53:07Z") , o1);
		o1.setPayment(pg1);
